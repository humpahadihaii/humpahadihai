...
const historyEras: HistoryEra[] = [
  {
    ...
    description: { 
      en: "The history of Uttarakhand is a narrative deeply embedded in the spiritual and geological consciousness of the Indian subcontinent. Long before the region was delineated by political boundaries, it existed as a sacred geography—a transcendental landscape where the metaphysical concept of Svarga Loka (the abode of the heavens) intersected with the rugged physical reality of the central Himalayas. The earliest references to this land are found in the Rig Veda, where the Sapta Sindhu region, watered by rivers originating in these very mountains, formed the cradle of Indo-Aryan civilization.",
      hi: "उत्तराखंड का इतिहास भारतीय उपमहाद्वीप की आध्यात्मिक और भौगोलिक चेतना में गहराई से समाहित एक कथा है। राजनीतिक सीमाओं से बहुत पहले, यह एक पवित्र भूगोल के रूप में विद्यमान था—एक पारलौकिक परिदृश्य जहां स्वर्ग लोक (स्वर्ग का निवास) की अवधारणा मध्य हिमालय की कठोर भौतिक वास्तविकता से मिलती थी। इस भूमि के सबसे पुराने संदर्भ ऋग्वेद में मिलते हैं, जहां इन्हीं पहाड़ों से निकलने वाली नदियों द्वारा सिंचित सप्त सिंधु क्षेत्र इंडो-आर्यन सभ्यता का पालना था।"
    },
    subsections: [
      {
        title: { en: "Prehistoric Habitation & Rock Art", hi: "प्रागैतिहासिक बसावट और शैल चित्र" },
        content: { 
          en: "Contrary to the colonial-era assumption that the high Himalayas were uninhabited terra incognita until the medieval period, archaeological evidence paints a picture of vibrant prehistoric activity. The rock shelters of Lakhudyar (literally 'one lakh caves'), located on the banks of the Suyal River in the Almora district, serve as a critical archive of this era. Here, paintings dating back to the Mesolithic and Chalcolithic periods depict stick-like human figures, animals, and geometric patterns in ochre, black, and white. These motifs bear a striking resemblance to the rock art of Bhimbetka in Central India, suggesting a continuity of paleolithic culture that spanned the subcontinent.\n\nFurther evidence is found in the megalithic cup-marks and burial cists discovered across the Kumaon and Garhwal hills. These sites indicate the presence of settled communities that practiced elaborate funerary rites and possessed a rudimentary understanding of astronomy and agriculture. Anthropologists identify these early inhabitants as the Kols (or Mundas), a proto-Australoid group who were the first to clear the forests and till the varied terrain of the Himalayan slopes. The Kols were eventually supplanted or absorbed by the Kiratas, a Mongoloid people whose presence is attested in the Mahabharata and who are believed to be the ancestors of the modern-day Bhotiya, Raji, and Tharu communities.",
          hi: "औपनिवेशिक-युग की इस धारणा के विपरीत कि मध्यकाल तक ऊंचे हिमालय निर्जन थे, पुरातात्विक साक्ष्य जीवंत प्रागैतिहासिक गतिविधि की तस्वीर पेश करते हैं। अल्मोड़ा जिले में सुयाल नदी के तट पर स्थित लखुड्यार (शाब्दिक अर्थ 'एक लाख गुफाएं') की शैल आश्रय इस युग का महत्वपूर्ण संग्रह है। यहां मध्यपाषाण और ताम्रपाषाण काल के चित्र गेरू, काले और सफेद रंग में मानव आकृतियों, जानवरों और ज्यामितीय पैटर्न को दर्शाते हैं। ये रूपांकन मध्य भारत के भीमबेटका की शैल कला से आश्चर्यजनक समानता रखते हैं।\n\nकुमाऊं और गढ़वाल की पहाड़ियों में खोजे गए महापाषाणकालीन कप-चिह्न और दफन पत्थर बस्तियों की उपस्थिति का संकेत देते हैं। मानवविज्ञानी इन प्रारंभिक निवासियों को कोल (या मुंडा) के रूप में पहचानते हैं, एक प्रोटो-ऑस्ट्रेलॉयड समूह जिन्होंने सबसे पहले जंगलों को साफ किया। कोलों को अंततः किरातों ने विस्थापित या आत्मसात कर लिया, जो आधुनिक भोटिया, राजी और थारू समुदायों के पूर्वज माने जाते हैं।"
        }
      },
      {
        title: { en: "Kedarkhand & Manaskhand: The Scriptural Geography", hi: "केदारखंड और मानसखंड: शास्त्रीय भूगोल" },
        content: { 
          en: "In the Puranic tradition, the region was not a single political entity but a dual sacred zone. The Skanda Purana, a massive compendium of Hindu mythology, bifurcates the central Himalayas into two distinct segments:\n\n• Kedarkhand: Corresponding to the modern Garhwal division, this region was dominated by the cult of Shiva. It derives its name from the Kedarnath shrine and is described as the land watered by the Alaknanda and Bhagirathi.\n\n• Manaskhand: Corresponding to the modern Kumaon division, this area was linked to the pilgrimage route toward Lake Manasarovar (Manas). It is also associated with the Kurma (tortoise) avatar of Vishnu, believed to have taken place at the Champawat hill, giving the region its alternative name, Kurmanchal.\n\nThis era also solidified Uttarakhand's reputation as Devbhoomi (Land of Gods). The Mahabharata contains explicit references to the Pandavas traversing this land during their Mahaprasthan (final journey to heaven). The sage Vyasa is believed to have composed the epic in the caves of Mana village near Badrinath, cementing the region's status as the intellectual and spiritual fountainhead of Sanatan Dharma.",
          hi: "पौराणिक परंपरा में, यह क्षेत्र एक राजनीतिक इकाई नहीं बल्कि एक दोहरा पवित्र क्षेत्र था। स्कंद पुराण, हिंदू पौराणिक कथाओं का विशाल संग्रह, मध्य हिमालय को दो अलग-अलग खंडों में विभाजित करता है:\n\n• केदारखंड: आधुनिक गढ़वाल मंडल के अनुरूप, यह क्षेत्र शिव के पंथ से प्रभुत्व रखता था। इसका नाम केदारनाथ मंदिर से लिया गया है और इसे अलकनंदा और भागीरथी द्वारा सिंचित भूमि के रूप में वर्णित किया गया है।\n\n• मानसखंड: आधुनिक कुमाऊं मंडल के अनुरूप, यह क्षेत्र मानसरोवर झील की तीर्थयात्रा मार्ग से जुड़ा था। यह विष्णु के कूर्म (कछुआ) अवतार से भी जुड़ा है।\n\nइस युग ने उत्तराखंड की देवभूमि (देवताओं की भूमि) के रूप में प्रतिष्ठा को भी मजबूत किया। महाभारत में पांडवों के महाप्रस्थान के दौरान इस भूमि को पार करने के स्पष्ट संदर्भ हैं। ऋषि व्यास ने बद्रीनाथ के पास माणा गांव की गुफाओं में महाकाव्य की रचना की।"
        }
      },
      {
        title: { en: "The Khasas: Indo-Aryan Influx", hi: "खस: इंडो-आर्यन आगमन" },
        content: { 
          en: "A pivotal demographic shift occurred with the arrival of the Khasas, an Indo-Aryan warrior tribe from Central Asia. Unlike the Vedic Aryans of the Gangetic plains who adhered to strict Brahminical orthodoxy, the Khasas practiced a more fluid social structure. They established a dominance that would define the sociological character of the hills for millennia.\n\nThe Khasa Contribution:\n• Origin: Indo-Aryan tribes from Central Asia; distinct from Vedic Aryans of the plains\n• Settlement: Displaced or assimilated the earlier Kol and Kirata populations\n• Religion: Practiced a nature-centric faith; worship of Masan, Bhuta, and later the Mahasu deity (in Jaunsar)\n• Social Structure: Less rigid caste system; practice of bride-price and, in some areas, polyandry\n• Legacy: Ancestors of the majority of the Rajput and Brahmin populations in the hills today\n\nThe Khasas introduced a distinct form of customary law and social organization, often centered around village republics or thokdars.",
          hi: "खसों के आगमन के साथ एक महत्वपूर्ण जनसांख्यिकीय परिवर्तन हुआ, जो मध्य एशिया से एक इंडो-आर्यन योद्धा जनजाति थी। गंगा के मैदानों के वैदिक आर्यों के विपरीत जो सख्त ब्राह्मणवादी रूढ़िवाद का पालन करते थे, खसों ने अधिक लचीली सामाजिक संरचना का अभ्यास किया।\n\nखस योगदान:\n• उत्पत्ति: मध्य एशिया से इंडो-आर्यन जनजातियां; मैदानों के वैदिक आर्यों से भिन्न\n• बसावट: पहले की कोल और किरात आबादी को विस्थापित या आत्मसात किया\n• धर्म: प्रकृति-केंद्रित आस्था; मसाण, भूत और बाद में महासू देवता (जौनसार में) की पूजा\n• सामाजिक संरचना: कम कठोर जाति व्यवस्था; वधू-मूल्य और कुछ क्षेत्रों में बहुपतित्व की प्रथा\n• विरासत: आज पहाड़ों में अधिकांश राजपूत और ब्राह्मण आबादी के पूर्वज"
        }
      },
      {
        title: { en: "The Kuninda Dynasty: First Hill Empire", hi: "कुनिंद राजवंश: पहला पहाड़ी साम्राज्य" },
        content: { 
          en: "The transition from tribal confederacies to organized statehood is marked by the rise of the Kuninda Dynasty (2nd century BCE – 3rd century CE). The Kunindas were the first power to unite the Garhwal and Kumaon regions under a single political umbrella. Their territory extended from the Sutlej river in the west to the Kali river in the east.\n\nThe most significant ruler of this dynasty was Amoghbhuti, whose name appears on beautiful silver and copper coins discovered across the region. These coins are invaluable historical documents; they feature a deer (representing the forest nature of the kingdom) alongside Buddhist symbols like the stupa and Hindu symbols like the swastika and Lakshmi. This numismatic evidence suggests a syncretic society where early Shaivism and Buddhism coexisted. The Kunindas were likely a trading power, controlling the lucrative salt and wool trade between Tibet and the Gangetic plains.",
          hi: "जनजातीय संघों से संगठित राज्य की ओर संक्रमण कुनिंद राजवंश (दूसरी शताब्दी ई.पू. – तीसरी शताब्दी ई.) के उदय से चिह्नित है। कुनिंद पहली शक्ति थे जिन्होंने गढ़वाल और कुमाऊं क्षेत्रों को एक राजनीतिक छत्र के तहत एकीकृत किया। उनका क्षेत्र पश्चिम में सतलुज नदी से पूर्व में काली नदी तक फैला था।\n\nइस राजवंश के सबसे महत्वपूर्ण शासक अमोघभूति थे, जिनका नाम क्षेत्र भर में खोजे गए सुंदर चांदी और तांबे के सिक्कों पर दिखाई देता है। ये सिक्के अमूल्य ऐतिहासिक दस्तावेज हैं; इनमें एक हिरण (राज्य की वन प्रकृति का प्रतिनिधित्व) के साथ बौद्ध प्रतीक जैसे स्तूप और हिंदू प्रतीक जैसे स्वास्तिक और लक्ष्मी दर्शाए गए हैं। यह एक समन्वयवादी समाज का संकेत देता है जहां प्रारंभिक शैव धर्म और बौद्ध धर्म सह-अस्तित्व में थे।"
        }
      },
      {
        title: { en: "The Ashokan Connection", hi: "अशोक से संबंध" },
        content: { 
          en: "The discovery of an Ashokan Rock Edict at Kalsi (near Dehradun) in 1860 provides definitive proof that the region was within the Mauryan sphere of influence as early as the 3rd century BCE. The edict, inscribed on a massive quartz rock, proclaims Ashoka's policy of non-violence and Dhamma. The location of the edict at the confluence of the Yamuna and Tons rivers indicates that this was a strategic gateway to the hills, likely serving as a trade depot and a center for Buddhist missionary activity.\n\nFollowing the decline of the Kunindas, the region saw a period of fragmentation. The Kushanas and later the Guptas exercised nominal suzerainty. The Allahabad Pillar inscription of Samudragupta mentions Kartripura (identified with the Katyur valley), suggesting that the hill kingdoms paid tribute to the Gupta empire while retaining internal autonomy.",
          hi: "1860 में कालसी (देहरादून के पास) में अशोक शिलालेख की खोज इस बात का निश्चित प्रमाण देती है कि यह क्षेत्र तीसरी शताब्दी ई.पू. में मौर्य प्रभाव क्षेत्र में था। एक विशाल क्वार्ट्ज चट्टान पर उत्कीर्ण यह शिलालेख अशोक की अहिंसा और धम्म की नीति की घोषणा करता है। यमुना और टोंस नदियों के संगम पर शिलालेख का स्थान इंगित करता है कि यह पहाड़ियों का एक रणनीतिक प्रवेश द्वार था, संभवतः एक व्यापार डिपो और बौद्ध मिशनरी गतिविधि का केंद्र।\n\nकुनिंदों के पतन के बाद, क्षेत्र में विखंडन का दौर आया। कुषाणों और बाद में गुप्तों ने नाममात्र की अधीनता का प्रयोग किया। समुद्रगुप्त के इलाहाबाद स्तंभ शिलालेख में कार्त्रिपुर (कत्यूर घाटी से पहचाना गया) का उल्लेख है।"
        }
      }
    ],
    highlights: { 
